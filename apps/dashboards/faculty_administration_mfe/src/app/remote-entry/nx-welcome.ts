      ...
      <div class="container">
        ...
        <div id="welcome">
          <h1>
            ...
            Welcome faculty_administration_mfe 👋
          </h1>
        </div>
        <!--  HERO  -->
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build faculty_administration_mfe
<span># Test</span>
nx test faculty_administration_mfe
<span># Lint</span>
nx lint faculty_administration_mfe
<span># Run them together!</span>
nx run-many -p faculty_administration_mfe -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project faculty_administration_mfe</pre>
          </details>
