...
export class StaffsPageComponent implements OnInit {
  ...
  loadStaffs(): void {
    this.isLoading = true;
    this.staffs$ = this.universityUserService
      .getAll(this.universityId, this.filters, this.selectedStatus)
  ...
  // ✅ Safe role name getter — handles both string[] and RoleResponse[]
