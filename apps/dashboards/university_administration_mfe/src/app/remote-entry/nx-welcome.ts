      ...
      <div class="container">
        ...
        <div id="welcome">
          <h1>
            ...
            Welcome university_administration_mfe 👋
          </h1>
        </div>
        <!--  HERO  -->
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build university_administration_mfe
<span># Test</span>
nx test university_administration_mfe
<span># Lint</span>
nx lint university_administration_mfe
<span># Run them together!</span>
nx run-many -p university_administration_mfe -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project university_administration_mfe</pre>
          </details>
