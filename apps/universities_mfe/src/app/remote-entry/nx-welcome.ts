      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build universities_mfe
<span># Test</span>
nx test universities_mfe
<span># Lint</span>
nx lint universities_mfe
<span># Run them together!</span>
nx run-many -p universities_mfe -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project universities_mfe</pre>
          </details>
